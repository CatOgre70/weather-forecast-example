...
import pro.sky.weatherforecastexample.config.BotState;
import pro.sky.weatherforecastexample.config.KeyboardType;
import pro.sky.weatherforecastexample.config.MainCommand;
import pro.sky.weatherforecastexample.service.*;
...
public class WeatherBotFacade {
    ...
    // @Autowired
    private WeatherBot weatherBot = new WeatherBot();
    @Autowired
